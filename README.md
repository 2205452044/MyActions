...
* 请勿将MyActions项目的任何内容用于商业或非法目的，否则后rewrwrwer读此声明。shuye72 保留随时更改或补充此免责声明的权利。一旦使用并复制了任何相关脚本或MyActions项目的规则，则视为您已接受此免责声明.
ewqewqe121211212
 **您必须在下载后的24小时内从计算机或手机中完全删除以上内容.**  </br>
 ***您使用或者复制了本仓库且本人制作的任何脚本，则视为`已接受`此f声明，请仔细阅读*** 

## 使用教程
WQWQWQ
### 一丶Github Action 使用教程1212
1. [按照这个教程进行 reposync](backup/reposync.md)1
2. 再在`Settings`-`Secrets`里面添加`JD_COOKIE`
3. 多条 cookie 用`&`隔开，支持无数条 cookie11ttt
